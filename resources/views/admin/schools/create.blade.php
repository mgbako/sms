                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select name="institution" class="form-control select2" style="width: 100%;">
                      <option selected="selected">Choose an Institution</option>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="session" class="form-control" placeholder="Enter ...">
                    </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="id_format" class="form-control" placeholder="Enter ...">
                    </div>
                </div>
                <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="number" class="form-control" placeholder="Enter number of questions">
                  </div><!-- /.form-group -->
                </div><!-- /.col -->
              </div><!-- /.row -->
            </div><!-- /.box-body -->
